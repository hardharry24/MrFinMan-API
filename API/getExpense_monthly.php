<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$sql = "SELECT SUM(amount) as sum from expense JOIN  user ON expense.userId = user.userId WHERE username = '".$username."'  AND DATE_FORMAT(expense.dateCreated,'%M') = '".$date."' AND `isDeleted`= 0";
